...
Java_com_norman_rtmp_rtmpclient_RTMPMuxer_open(JNIEnv* env, jobject thiz, jstring url_,
...
JNIEXPORT jint JNICALL
Java_com_norman_rtmp_rtmpclient_RTMPMuxer_writeAudio(JNIEnv* env, jobject thiz, jbyteArray data_,
...
JNIEXPORT jint JNICALL
Java_com_norman_rtmp_rtmpclient_RTMPMuxer_writeVideo(JNIEnv* env, jobject thiz, jbyteArray data_,
                                                       jint offset, jint length, jlong timestamp) {
    jbyte *data = (*env)->GetByteArrayElements(env, data_, NULL);
...
JNIEXPORT jint JNICALL
Java_com_norman_rtmp_rtmpclient_RTMPMuxer_close(JNIEnv* env, jobject thiz) {
    rtmp_close();
...
JNIEXPORT jint JNICALL
Java_com_norman_rtmp_rtmpclient_RTMPMuxer_read(JNIEnv* env, jobject thiz, jbyteArray data_,
